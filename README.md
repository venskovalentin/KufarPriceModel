...
лоты, а также предсказывать цены на товары. Проект создан в качестве курсовой работы.

> Метрики последней модели (на ~8 000 объявлений): **R² = 0.756, MAE ≈ 396 BYN,
> RMSE ≈ 901 BYN, MAPE=47%, MedAE=147 BYN**, 
...
- **🔄 Model в один клик** — фоновый поток парсит свежие данные с Kufar,
